...
public class Npc_OldMan extends Entity{
    ...
    public void getNpcImage() {
        up1 = setup("/res/npc/tile009");
        up2 = setup("/res/npc/tile011");
        down1 = setup("/res/npc/tile000");
        down2 = setup("/res/npc/tile002");
        left1 = setup("/res/npc/tile003");
        left2 = setup("/res/npc/tile005");
        right1 = setup("/res/npc/tile006");
        right2 = setup("/res/npc/tile008");
    }
